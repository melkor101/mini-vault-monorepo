    ...
    return (
      <div className="min-h-screen bg-[#1A1A2E] flex items-center justify-center p-4">
        <div className="w-full max-w-sm text-center">
          <div className="w-16 h-16 rounded-2xl bg-[#4CAF50]/20 border border-[#4CAF50]/30 flex items-center justify-center mx-auto mb-5">
          ...
          <Link
            href="/login"
            className="text-sm text-[#6C63FF] hover:text-[#8880FF] transition-colors"
          >
            Back to sign in
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-[#1A1A2E] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-white/40 mt-1">Start tracking your collection</p>
        </div>
        ...
        <p className="text-center text-sm text-white/30 mt-5">
          ...
          <Link href="/login" className="text-[#6C63FF] hover:text-[#8880FF] transition-colors font-medium">
            Sign in
          </Link>
        </p>
